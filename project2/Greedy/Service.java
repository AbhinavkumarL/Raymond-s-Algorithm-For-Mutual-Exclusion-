...
/**
	...
	public void loadFile() throws IOException{
		...
		for (String Line : Files.readAllLines(Paths.get(System.getProperty("user.dir") + "/config.txt"))){
	 ...
	 * @return null
	 */
	public void  buildNodes(String host, int port, int neighbor) throws Exception{
		...
		while(node.getNumRequest()>0){
			...
			node.decNumRequest();
			System.out.println("line 75:request number:="+node.getNumRequest() +":Total requests:"+node.totalRequest);
		}
	}
