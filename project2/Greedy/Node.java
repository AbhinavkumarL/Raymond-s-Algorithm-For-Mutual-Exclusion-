...
public class Node{
	...
	LinkedList<String> requestQ = new LinkedList<>();
	...
	public boolean contains(){
		return this.requestQ.contains(host+","+port);
	}
	public void remove(){
		boolean x = this.requestQ.removeFirstOccurrence(host+","+port);
	}

	// public void msgComplexity(){
	// 	System.out.println("Message Complexity of this process:="+ msgComp);
	// }
}